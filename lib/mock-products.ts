...
export const products: Product[] = [
  ...
  },
  {
    ...
    sizeOptions: [
      ...
      { label: '8', sublabel: '48.1 mm', priceModifier: 0, stock: 'In Stock' },
      { label: '9', sublabel: '49.0 mm', priceModifier: 0, stock: 'In Stock' },
      { label: '10', sublabel: '50.0 mm', priceModifier: 0, stock: 'Made to Order' },
      { label: '11', sublabel: '50.9 mm', priceModifier: 0, stock: 'Made to Order' },
      { label: '12', sublabel: '51.8 mm', priceModifier: 0, stock: 'In Stock' },
      { label: '13', sublabel: '52.8 mm', priceModifier: 0, stock: 'Made to Order' },
    ],
